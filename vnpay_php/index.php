...
<html lang="en">
    <head>
        ...
        <title>Sneaker Shop - Thanh toán</title>
        <!-- Bootstrap core CSS -->
    ...
    <body>
        ...
        <div class="container">
            <div class="header clearfix">
                <h3 class="text-muted">THANH TOÁN ĐƠN HÀNG SNEAKER SHOP</h3>
            </div>
            ...
            <div class="table-responsive">
                <form action="/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        style = "pointer-events:none; background-color:#BBBBBB;" 
                        name="order_id" type="text" value="<?php echo date("YmdHis") ?>"/>
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                                style = "pointer-events:none; background-color:#BBBBBB;"
                               name="amount" type="number" value="<?php echo $qtt; ?>" 
                       />
                    </div>
                    <div class="form-group">
